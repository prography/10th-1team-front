...
export const listItemVariants = cva("flex justify-between", {
  variants: {
    variant: {
      ...
      "platform-vote": "bg-button-neutral-bg_default border border-button-neutral-border text-button-neutral-text_default hover:bg-surface-normal-container-b50 hover:text-texticon-onnormal-main-500 hover:border-brand-primary-main",
    },
  },
  defaultVariants: {
