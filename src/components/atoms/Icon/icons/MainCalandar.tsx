...
export default function MainCalandar({
  size = 48,
  disabled = false,
}: MainCalandarProps) {
  return (
    ...
    >
      ...
      <rect
        ...
        rx="2"
        fill={
          disabled ? colors.Border.Normal.LowestEmp : colors.Brand.Primary.Light
        }
      />
      <path
        d="M10 14C10 12.8954 10.8954 12 12 12H36C37.1046 12 38 12.8954 38 14V20H10V14Z"
        fill={
          disabled ? colors.Border.Normal.LowEmp : colors.Brand.Primary.Main
        }
      />
      <path
