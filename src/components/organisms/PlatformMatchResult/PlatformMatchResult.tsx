  ...
  return (
    <div>
      <div className='flex flex-col py-[42px] px-[16px] items-center justify-center'>
        ...
        <p className='mb-[8px] body-m-semibold text-texticon-onnormal-highemp'>아직 투표가 없어요</p>
        <p className='caption-m-regular text-texticon-onnormal-midemp'>첫 번째 투표자가 되어주세요</p>
      </div>
      <Button 
          variant={'primary'} 
