        ...
        <div className='bg-surface-normal-bg01 py-[16px] w-full max-w-full overflow-hidden'>
            <div className='px-[16px] gap-[12px] flex flex-col'>
                ...
                <div className='gap-[4px] flex flex-col'>
                    <p className='body-l-semibold text-texticon-onnormal-highemp'>어느쪽 리뷰가 더 신뢰가나요?</p>
                    <p className='caption-m-regular text-texticon-onnormal-midemp'>더 유용한 정보를 제공한 플랫폼과 이유를 투표해주세요</p>
                </div>
            </div>
            <Tabs items={tabItems} />
